      ...
      <div class="overflow-y-auto bg-[#C4C4C4] rounded-lg w-2/3 h-1/2">
        <div class="py-2 inline-block min-w-full px-6">
          ...
          <div class="flex justify-center mt-16 flex-col items-center">
            ...
            <div class="flex items-center"><button @click="" class="rounded-md bg-[#585858] text-white font-bold text-xl p-3 mt-4 mb-4 "><p class="text-white hover:text-yellow-100 ease-in-out duration-200" >Crear partida</p></button></div>
          </div>
        </div>
      </div>
    </div>
